...
<nav role="navigation" class="navbar-default navbar-static-side">
     <div class="sidebar-collapse">				  
       <ul id="sidemenu" class="nav expanded-menu">
        ...
        <li class="active" >
			 	<a href="<?php echo url('/'); ?>/pricelist" >
				 	<i class="fa fa-2x fa-bolt"></i> <span class="nav-label">Pricelist</span>
				</a>
          </li>
        <li class="active" >
			 	<a href="<?php echo url('/'); ?>/sfsix" >
				 	<i class="fa fa-2x fa-bolt"></i> <span class="nav-label">SF6 Database</span>
				</a>
          </li>
