...
<div class="container" style="margin-top: 10px; margin-bottom: 10px;width:100%">
    <div class="row">
        <div class="progress" id="progress1">
            <div class="progress-bar" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 45%;">
            </div>
...
<ul class="nav nav-tabs">
	...
	<li onclick="displayprice()" class="active"><a href='#' > Rodenstock Nahkomfortgläser   </a></li>
...
<div class="tab-content m-t">
  ...
  <form method='post' action="<?php echo url('stepthree/process') ;?>" >
		 <div class="form-horizontal row" >
         <div class="col-sm-12 animated fadeInRight ">
		  <h3>Rodenstock Nahkomfortgläser </h3>
		  <p>Choose sterben Produkte ab , sterben auf Ihrer individuellen Preisliste Nicht erscheinen Sollen</p>
			...
			<div class='col-md-4'>
					...
					<div class='form-group row' style='margin-left:20px;font-size:16px;font-weight:700'>
						Impression Ergo FS 2<br>  &nbsp;&nbsp;<input type='radio' name='prl_imp_ergo_fs_2' selected value='Yes'>
					</div>
					<div class='form-group row' style='margin-left:20px;font-size:16px;font-weight:700'>
						Impression Ergo 2 <br> &nbsp;&nbsp;<input type='radio' name='prl_imp_ergo_2' selected value='Yes'>
					</div>
			...
			<div class='col-md-4'>
					...
					<div class='form-group row' style='margin-left:20px;font-size:16px;font-weight:700'>
						Multigressiv Ergo 2<br>  &nbsp;&nbsp;<input type='radio' name='prl_multi_ergo_2' selected value='Yes'>
					</div>
			...
			<div class='col-md-4'>
					...
					<div class='form-group row' style='margin-left:20px;font-size:16px;font-weight:700'>
						Progressiv Ergo <br>&nbsp;&nbsp;<input type='radio' name='prl_prog_ergo' selected value='Yes'>
					</div>
	...
	<div class=" col-md-4"></div>
		<div class="col-md-2">
				<a href="http://etnblessings.net/pdf/sximo/public/steptwo"  class="btn btn-primary" style="width:100%" > &lt;&lt; Prev  </a>
		</div>
		<div class=" col-md-2">
